 ...
 */
{
  ...
  "def": {
	...
	"colorRatingWN8": {
      ...
      "good":			"0x459300",    // good
      "very_good":		"0x1DFF9E",    // very good
      "great":			"0x43F1FF",    // great
      "unicum":			"0xD156FF",    // unicum
      "super_unicum":	"0x8D31B8"    // super_unicum
    },
  ...
  "colors": {
    ...
    "wn8": [
	  { "value": 300,  "color": ${"def.colorRatingWN8.very_bad" 		} },
	  { "value": 450,  "color": ${"def.colorRatingWN8.bad" 			} },
	  { "value": 650,  "color": ${"def.colorRatingWN8.below_average"	} },
	  { "value": 900,  "color": ${"def.colorRatingWN8.average"			} },
	  { "value": 1200, "color": ${"def.colorRatingWN8.above_average"	} },
	  { "value": 1600, "color": ${"def.colorRatingWN8.good"				} },
	  { "value": 2000, "color": ${"def.colorRatingWN8.very_good"		} },
	  { "value": 2450, "color": ${"def.colorRatingWN8.great"			} },
	  { "value": 2900, "color": ${"def.colorRatingWN8.unicum"			} },
	  { "value": 9999, "color": ${"def.colorRatingWN8.super_unicum"		} } 
    ],
    ...
    "winrate": [
	  { "value": 46,  "color": ${"def.colorRatingWN8.very_bad"		} },
	  { "value": 47,  "color": ${"def.colorRatingWN8.bad"			} },
	  { "value": 48,  "color": ${"def.colorRatingWN8.below_average"	} },
	  { "value": 50,  "color": ${"def.colorRatingWN8.average"		} },
	  { "value": 52, "color": ${"def.colorRatingWN8.above_average"	} },
	  { "value": 54, "color": ${"def.colorRatingWN8.good"			} },
	  { "value": 56, "color": ${"def.colorRatingWN8.very_good"		} },
	  { "value": 60, "color": ${"def.colorRatingWN8.great"			} },
	  { "value": 65, "color": ${"def.colorRatingWN8.unicum"			} },
	  { "value": 101, "color": ${"def.colorRatingWN8.super_unicum"	} } 
    ],
